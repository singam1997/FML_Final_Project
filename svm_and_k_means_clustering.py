...
Original file is located at
    https://colab.research.google.com/drive/1sZ4ej7fQs-xl0isc5xn5EA8wrNhzQ7Kn
"""
...
def pre_process(file_name):
  ...
  #For Imputation: https://scikit-learn.org/stable/modules/impute.html
  imp = SimpleImputer(missing_values=np.nan, strategy='mean')
  imp.fit(X_withNaNs[0:math.floor(0.8*len(X_withNaNs))])
  ...
  return (imp,scaler,data,outlier_removed_not_scaled_y)

def split_data(data,outlier_removed_not_scaled_y,mode=0):
  size=len(data)
...
def train_test_score(train_X,train_y,test_X,test_y,classifier="SVM"):
  ...
  if  classifier=="SVM":
    ...
    # Accuracy Measures https://scikit-learn.org/stable/modules/generated/sklearn.metrics.accuracy_score.html
    ...
    return grid
  elif classifier=="K-means":
    from sklearn.cluster import KMeans
    kmeans = KMeans(n_clusters=2, random_state=0).fit(train_X,train_y)
    
    from sklearn.metrics import accuracy_score

    from sklearn.metrics import classification_report, confusion_matrix
    cf_matrix = confusion_matrix(test_y, kmeans.predict(test_X))

    print(classification_report(test_y,  kmeans.predict(test_X)))

    # Visualizations: https://seaborn.pydata.org/generated/seaborn.heatmap.html
    import seaborn as sns
    sns.heatmap(cf_matrix, annot=True, fmt='g')
    return kmeans
...
file_name="https://0f41bdd6-d0a9-458e-937c-838e849bb6f4.usrfiles.com/ugd/0f41bd_2fc1e03928274e439b9a30a1422eff19.csv"
(imputer,scaler,X,y)=pre_process(file_name)
(train_X,train_y,test_X,test_y)=split_data(X,y,0)
clf=train_test_score(train_X,train_y,test_X,test_y,"K-means")

"""USING SVM"""

clf=train_test_score(train_X,train_y,test_X,test_y,"SVM")
...
forecast(scaler=scaler,clf=clf,Glucose=148,SkinThickness=35,DiabetesPedigreeFunction=0.627,Age=50)